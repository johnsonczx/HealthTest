...
import org.njgroup.health.leiyu.heartrate.HeartRateChart;
import org.njgroup.health.leiyu.heartrate.ImageProcessing;
import org.njgroup.health.leiyu.heartrate.ToastUtil;
import org.njgroup.health.leiyu.heartrate.UIHelper;
...
/**
 * Created by leiyu on 2017/07/17.
 */
@RuntimePermissions
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
            ...
            public void uncaughtException(Thread thread, Throwable throwable) {
                Log.e("njgroup",Log.getStackTraceString(throwable));
                System.exit(0);
            }
        });
