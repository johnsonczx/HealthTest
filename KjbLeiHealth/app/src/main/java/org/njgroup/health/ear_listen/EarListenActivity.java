...
public class EarListenActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ear_listen);
        initTitleBar("听力测试", true);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.bt_hearvoice:
                if (bt_play.getText().toString().equals(TEXT_PLAY)) return;
                if (listenTest.getLowvalue() <= 0) {
